...
class _HistoryPageState extends State<HistoryPage> {
  ...
  Future<void> _loadHistory() async {
    final email = await LocalDatabase().getCurrentUserEmail();

    if (email != null) {
      final data = await HistoryDatabase.instance.readByEmail(email);
      setState(() {
        history = data;
      });
    }
          ...
          actions: <Widget>[
            ...
            TextButton.icon(
              ...
              onPressed: () async {
                ...
                if (deletedId != null) {
                  final deletedRows =
                      await HistoryDatabase.instance.delete(deletedId);
